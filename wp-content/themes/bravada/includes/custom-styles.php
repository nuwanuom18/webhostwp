...
function bravada_body_classes( $classes ) {
	$options = cryout_get_option( array(
		...
		'theme_tables', 'theme_normalizetags', 'theme_articleanimation', 'theme_headertitle_anim'
	) );
...
<?php /*button, input[type="button"], input[type="submit"], input[type="reset"], */ ?>
...
span.edit-link .icon-edit:before {
	color: <?php echo esc_html( $theme_sitetext, 19 ) ?>;
}
