...
if ( ! function_exists( 'deep_theme_setup' ) ) :
	/**
...
function deep_theme_scripts() {
	...
	wp_enqueue_script( 'deep-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), DEEPTHEME, true );
 ...
 * Deep Init.
 */
require get_template_directory() . '/inc/class-deep-theme-init.php';
